...
async function fixTacoTuesdayFile() {
  console.log('🔧 Fixing Taco Tuesday file location...\n');

  const streamKey = 'tacotuesdaygrytmu1n';
...
fixTacoTuesdayFile().catch(console.error);
