...
export const seedApps: App[] = [
  ...
  },
  {
    ...
    slug: "dropflow",
    description:
      "Sell your original songs and beats with built-in signals. Pay-what-you-want (min $1), instant receipt and license, Stripe payouts.",
    thumbnailUrl: "https://placehold.co/400x225/1a1a1a/22c55e?text=Dropflow",
    siteUrl: "/dropflow",
    status: "active",
    listed: true,
    priceCents: 0,
    shareTitle: "Dropflow | Statics",
    shareDescription: "Sell songs and beats with built-in signals. Pay-what-you-want, receipt and license, Stripe payouts.",
    shareImageUrl: "https://placehold.co/1200x630/1a1a1a/22c55e?text=Dropflow",
    canonicalUrl: "https://statics.example.com/dropflow",
    createdBy: "user-admin-1",
    createdAt: "2025-01-01T00:00:00Z",
    updatedAt: "2025-01-01T00:00:00Z",
  },
