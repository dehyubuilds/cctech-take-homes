    ...
    <div className="mx-auto max-w-2xl px-4 py-20 sm:py-28 text-center">
      ...
      {!loading && session ? (
        <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Link
            href="/profile"
            className="w-full sm:w-auto rounded-xl border border-gray-600 px-8 py-3.5 text-base font-medium text-white hover:bg-white/5 transition-colors min-h-[48px] flex items-center justify-center"
          >
            Profile
          </Link>
        </div>
